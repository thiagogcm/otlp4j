...
- An unattached receiver source rejects retryably. Attach every signal that must be processed, or call `discard()` on signals that should be accepted and dropped intentionally.
