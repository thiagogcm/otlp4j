...
/// [ClientTransportConfig.Builder]. Package-private (reached only through
/// [ClientTransportConfig.Builder#fromEnvironment()]), so it stays out of the exported `spi`
...
final class OtlpEnv {
    ...
    private static void applyEndpoint(
            ClientTransportConfig.Builder builder, String raw, UnaryOperator<String> env) {
        URI uri;
        try {
